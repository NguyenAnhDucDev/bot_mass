...
**💬 Message Commands:**
• `!send -p <partner> -c <channel1> -c <channel2> | <content>` - Send message
...
• `!send -p "Client A" -c general | Important announcement`
• `!send -p "hoàng_thượng" -c -all -p "huy" -c "abp868" | Test message`
• `!list -p "Client A" -all`
